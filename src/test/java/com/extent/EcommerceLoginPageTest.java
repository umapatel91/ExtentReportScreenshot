...
public class EcommerceLoginPageTest {
	...
	public void setExtent(){
		...
		extent.addSystemInfo("Host Name", "Keshav-PC");
		extent.addSystemInfo("User Name", "erpan");
		extent.addSystemInfo("OS", "Windows 10");
		extent.addSystemInfo("Java Version", "13.0.1");
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		if(result.getStatus()==ITestResult.FAILURE){
			...
			String screenshotPath = EcommerceLoginPageTest.getScreenshot(driver, result.getName());
